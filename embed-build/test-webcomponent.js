const ssoUrl = `https://dev-flow.viasocket.com/sso`;
const urlToViasocket = `https://dev-embedfrontend.viasocket.com/embed`
const loginurl = 'https://dev-api.viasocket.com/users/register'
const styleurl="https://embed.viasocket.com/style-local.css"
